...
const Admin = () => {
      const navigate = useNavigate();
            ...
            const handleAddProduct = async (e) => {
              ...
              try {
                ...
                const response = await axios.post(`${process.env.REACT_APP_API_URL}/product_details`, formData, {
            ...
            const deleteProduct = async (productId) => {
              try {
                await axios.delete(`${process.env.REACT_APP_API_URL}/api/delete/product/${productId}`);
  ...
  return (
    <div>
      ...
      <h2 style={{ color: "#28a745",marginLeft:"-30px" }}>Add New Gold Jewellery</h2>
      <form
            ...
            {products.length > 0 ? (
              products.map((product, index) => (
                <tr key={product._id}>
                  ...
                  <td>
                    <Link to={`/update/product/${product._id}`} className="btn btn-info btn-sm">
